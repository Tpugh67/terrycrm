...
const DEMO_DEALS = [
  { id: 1, title: "Henderson Residential 8kW", client: "Bob Henderson", systemSize: "8 kW", commission: "$2,400", stage: "New Lead", hot: true, followUp: "Overdue" },
  { id: 2, title: "Nguyen Commercial 45kW", client: "Tina Nguyen", systemSize: "45 kW", commission: "$9,000", stage: "Site Survey", hot: true, followUp: "Today" },
  { id: 3, title: "Park Residential 12kW", client: "James Park", systemSize: "12 kW", commission: "$3,600", stage: "Proposal Sent", hot: false, followUp: "Tomorrow" },
  { id: 4, title: "Miller Farm 120kW", client: "Dale Miller", systemSize: "120 kW", commission: "$18,000", stage: "Permitting", hot: true, followUp: "Next week" },
  { id: 5, title: "Torres Residential 6kW", client: "Carmen Torres", systemSize: "6 kW", commission: "$1,800", stage: "Installed", hot: false, followUp: "Done" },
];

const STAGES = ["New Lead", "Site Survey", "Proposal Sent", "Permitting", "Installed"];
    ...
    <div className="min-h-screen bg-white">
      <nav className="border-b border-slate-200 px-6 py-4 flex items-center justify-between sticky top-0 bg-white z-50">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href="/login?mode=signup&industry=solar" className="bg-blue-600 hover:bg-blue-700 text-white text-sm font-semibold px-4 py-2 rounded-lg transition">Start free trial</Link>
        </div>
      </nav>
      <section className="bg-slate-900 text-white py-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 bg-yellow-600/20 text-yellow-400 text-xs font-semibold px-4 py-2 rounded-full mb-6 border border-yellow-600/30">☀️ Solar Sales Consultants</div>
          <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Your solar pipeline,<br />from lead to install</h1>
          <p className="text-xl text-slate-400 max-w-2xl mx-auto mb-10">Track system size, proposals, permits, and installs. Log every site visit and follow-up. Built for solar reps — not generic salespeople.</p>
          <Link href="/login?mode=signup&industry=solar" className="inline-block bg-blue-600 hover:bg-blue-700 text-white font-bold text-lg px-10 py-4 rounded-xl transition">Start your free 14-day trial →</Link>
              ...
              <div key={deal.id} className="bg-white rounded-xl border border-slate-200 p-5 shadow-sm hover:shadow-md transition">
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1">
                    ...
                    <div className="text-sm text-slate-500">Client: {deal.client} · {deal.systemSize}</div>
                  </div>
                ...
                <div className="mt-3 pt-3 border-t border-slate-100 flex items-center justify-between">
                  ...
                  <div className="flex gap-2">
                    ...
                    <button className="text-xs bg-blue-50 hover:bg-blue-100 text-blue-600 px-3 py-1.5 rounded-lg transition">📋 Log Visit</button>
                  </div>
                </div>
              </div>
            ))}
      ...
      <section className="bg-slate-900 py-20 px-6">
        <div className="max-w-2xl mx-auto text-center">
          <h2 className="text-3xl font-bold text-white mb-4">Ready to install more systems?</h2>
          <p className="text-slate-400 text-lg mb-8">Start your free 14-day trial. No charge until it ends.</p>
          <Link href="/login?mode=signup&industry=solar" className="inline-block bg-blue-600 hover:bg-blue-700 text-white font-bold text-lg px-10 py-4 rounded-xl transition">Start free trial →</Link>
