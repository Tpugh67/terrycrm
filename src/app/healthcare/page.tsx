...
const DEMO_DEALS = [
  { id: 1, title: "New Patient - Knee Pain", client: "John Martinez", val: "$8,500", val2: "Blue Cross", stage: "New Patient", hot: true, follow: "Overdue" },
  { id: 2, title: "Back Surgery Follow-up", client: "Amy Thompson", val: "$12,000", val2: "Aetna", stage: "Consultation", hot: true, follow: "Today" },
  { id: 3, title: "Physical Therapy Plan", client: "Robert Garcia", val: "$4,500", val2: "United Health", stage: "Treatment Plan", hot: false, follow: "Tomorrow" },
  { id: 4, title: "Shoulder Replacement", client: "Lisa Chen", val: "$35,000", val2: "Medicare", stage: "In Treatment", hot: true, follow: "Next week" },
  { id: 5, title: "Annual Checkup", client: "Tom Wilson", val: "$850", val2: "Blue Shield", stage: "Discharged", hot: false, follow: "Done" },

];

const STAGES = ["New Patient", "Consultation", "Treatment Plan", "In Treatment", "Discharged"];
    ...
    <div className="min-h-screen bg-white">
      <nav className="border-b border-slate-200 px-6 py-4 flex items-center justify-between sticky top-0 bg-white z-50">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href="/login?mode=signup&industry=healthcare" className="bg-cyan-600 hover:bg-cyan-700 text-white text-sm font-semibold px-4 py-2 rounded-lg transition">Start free trial</Link>
        </div>
      </nav>

      <section className="bg-slate-900 text-white py-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 bg-white/10 text-white/80 text-xs font-semibold px-4 py-2 rounded-full mb-6 border border-white/20">🏥 Healthcare Practices & Clinics</div>
          <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Your patient pipeline,
built for practices</h1>
          <p className="text-xl text-slate-400 max-w-2xl mx-auto mb-10">Track patients from first contact to active care, manage treatment plans, and grow your practice.</p>
          <Link href="/login?mode=signup&industry=healthcare" className="inline-block bg-cyan-600 hover:bg-cyan-700 text-white font-bold text-lg px-10 py-4 rounded-xl transition">Start your free 14-day trial →</Link>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
            {[
              ...
              { label: "Pipeline Value", value: `$${(totalVal/1000).toFixed(0)}K`, icon: "💰", color: "text-cyan-600" },
              ...
              <div key={deal.id} className="bg-white rounded-xl border border-slate-200 p-5 shadow-sm hover:shadow-md transition">
                <div className="flex items-start justify-between gap-4">
                  ...
                  <div className="text-right">
                    ...
                    <div className={`text-2xl font-bold text-cyan-600`}>{deal.val}</div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <div className="text-sm text-slate-500 leading-relaxed">Track every patient from first contact to discharged with healthcare-specific stages.</div>
              </div>
            </div>
            <div className="flex gap-4 p-6 bg-slate-50 rounded-2xl border border-slate-100">
              <div className="text-3xl">💰</div>
              <div>
                <div className="font-bold text-slate-900 mb-1">Treatment Value</div>
                <div className="text-sm text-slate-500 leading-relaxed">Track treatment value, insurance coverage, and patient responsibility on every case.</div>
              </div>
            </div>
            <div className="flex gap-4 p-6 bg-slate-50 rounded-2xl border border-slate-100">
              <div className="text-3xl">📅</div>
              <div>
                ...
                <div className="text-sm text-slate-500 leading-relaxed">Set follow-up appointments and get alerts when patients need follow-up care.</div>
              </div>
            </div>
            <div className="flex gap-4 p-6 bg-slate-50 rounded-2xl border border-slate-100">
              <div className="text-3xl">📊</div>
            ...
            <div className="flex gap-4 p-6 bg-slate-50 rounded-2xl border border-slate-100">
              <div className="text-3xl">🔥</div>
              <div>
                <div className="font-bold text-slate-900 mb-1">Priority Patient Alerts</div>
                <div className="text-sm text-slate-500 leading-relaxed">High-value treatments get flagged so you prioritize the right cases.</div>
              </div>
            </div>
            <div className="flex gap-4 p-6 bg-slate-50 rounded-2xl border border-slate-100">
              <div className="text-3xl">📞</div>
              <div>
                ...
                <div className="text-sm text-slate-500 leading-relaxed">Log every call, visit, and note with one click.</div>
              </div>
            </div>
      ...
      <section className="bg-slate-900 py-20 px-6">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <Link href="/login?mode=signup&industry=healthcare" className="inline-block bg-cyan-600 hover:bg-cyan-700 text-white font-bold text-lg px-10 py-4 rounded-xl transition">Start free trial →</Link>
