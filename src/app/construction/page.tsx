...
const DEMO_DEALS = [
  { id: 1, title: "Henderson Kitchen Remodel", client: "Bob Henderson", value: "Bid: $45,000", commission: "Margin: $12,000", stage: "Bid Submitted", hot: true, followUp: "Overdue" },
  { id: 2, title: "Garcia Office Build-Out", client: "Maria Garcia", value: "Bid: $180,000", commission: "Margin: $45,000", stage: "Negotiating", hot: true, followUp: "Today" },
  { id: 3, title: "Lee Residential Addition", client: "Kevin Lee", value: "Bid: $95,000", commission: "Margin: $22,000", stage: "Contract Signed", hot: false, followUp: "Tomorrow" },
  { id: 4, title: "Williams Commercial Roofing", client: "Dale Williams", value: "Bid: $68,000", commission: "Margin: $18,000", stage: "In Progress", hot: true, followUp: "Next week" },
  { id: 5, title: "Thompson New Home Build", client: "James Thompson", value: "Bid: $420,000", commission: "Margin: $84,000", stage: "Completed", hot: false, followUp: "Done" },
];

const STAGES = ["Bid Submitted", "Negotiating", "Contract Signed", "In Progress", "Completed"];
const STAGE_COLORS: Record<string, string> = {
  "Bid Submitted": "bg-slate-100 text-slate-700",
  "Negotiating": "bg-blue-100 text-blue-700",
  "Contract Signed": "bg-yellow-100 text-yellow-700",
    ...
    <div className="min-h-screen bg-white">
      <nav className="border-b border-slate-200 px-6 py-4 flex items-center justify-between sticky top-0 bg-white z-50">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href="/login?mode=signup&industry=construction" className="bg-blue-600 hover:bg-blue-700 text-white text-sm font-semibold px-4 py-2 rounded-lg transition">Start free trial</Link>
        </div>
      </nav>
      <section className="bg-slate-900 text-white py-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 bg-blue-600/20 text-blue-400 text-xs font-semibold px-4 py-2 rounded-full mb-6 border border-blue-600/30">🏗️ Contractors & Construction Companies</div>
          <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Your project pipeline,\nbuilt for contractors</h1>
          <p className="text-xl text-slate-400 max-w-2xl mx-auto mb-10">Track bids, contracts, and project milestones. Log every site visit and client call. Built for contractors — not generic salespeople.</p>
          <Link href="/login?mode=signup&industry=construction" className="inline-block bg-blue-600 hover:bg-blue-700 text-white font-bold text-lg px-10 py-4 rounded-xl transition">Start your free 14-day trial →</Link>
      ...
      <section className="bg-slate-900 py-20 px-6">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <Link href="/login?mode=signup&industry=construction" className="inline-block bg-blue-600 hover:bg-blue-700 text-white font-bold text-lg px-10 py-4 rounded-xl transition">Start free trial →</Link>
