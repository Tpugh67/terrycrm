          ...
          <div className="min-h-screen flex">
            <aside className="w-72 bg-slate-950 text-white flex flex-col border-r border-slate-800">
              ...
              <nav className="flex-1 px-4 py-4 space-y-1 text-sm overflow-y-auto">
                ...
                <Link href="/solar" className="flex items-center gap-3 rounded-xl px-4 py-2.5 hover:bg-yellow-900/40 transition group"><span className="w-6 h-6 rounded-md bg-yellow-500 flex items-center justify-center text-[10px] font-bold flex-shrink-0">☀️</span><span className="text-slate-300 group-hover:text-white transition">Solar Energy</span></Link>
                ...
                <Link href="/legal" className="flex items-center gap-3 rounded-xl px-4 py-2.5 hover:bg-slate-700/40 transition group"><span className="w-6 h-6 rounded-md bg-slate-700 flex items-center justify-center text-[10px] font-bold flex-shrink-0">⚖️</span><span className="text-slate-300 group-hover:text-white transition">Legal</span></Link>
              ...
              <div className="px-6 py-4 border-t border-slate-800 text-xs text-slate-500">PipeDesk v1 · 8 Industries · pipedesk.app</div>
            </aside>
...
// force deploy Thu Apr 23 19:16:17 EDT 2026
