          ...
          <div className="min-h-screen flex">
            <aside className="w-72 bg-slate-950 text-white flex flex-col border-r border-slate-800">
              ...
              <nav className="flex-1 px-4 py-4 space-y-1 text-sm overflow-y-auto">
                ...
                <Link href="/trucking" className="flex items-center gap-3 rounded-xl px-4 py-2.5 hover:bg-blue-900/40 transition group"><span className="w-6 h-6 rounded-md bg-blue-800 flex items-center justify-center text-[10px] font-bold flex-shrink-0">TR</span><span className="text-slate-300 group-hover:text-white transition">Trucking & Logistics</span></Link>
                <Link href="/dental" className="flex items-center gap-3 rounded-xl px-4 py-2.5 hover:bg-sky-900/40 transition group"><span className="w-6 h-6 rounded-md bg-sky-500 flex items-center justify-center text-[10px] font-bold flex-shrink-0">DT</span><span className="text-slate-300 group-hover:text-white transition">Dental</span></Link>
                <Link href="/fitness" className="flex items-center gap-3 rounded-xl px-4 py-2.5 hover:bg-green-900/40 transition group"><span className="w-6 h-6 rounded-md bg-green-600 flex items-center justify-center text-[10px] font-bold flex-shrink-0">FW</span><span className="text-slate-300 group-hover:text-white transition">Fitness & Wellness</span></Link>
                <Link href="/nonprofit" className="flex items-center gap-3 rounded-xl px-4 py-2.5 hover:bg-rose-900/40 transition group"><span className="w-6 h-6 rounded-md bg-rose-600 flex items-center justify-center text-[10px] font-bold flex-shrink-0">NP</span><span className="text-slate-300 group-hover:text-white transition">Nonprofit</span></Link>
                <Link href="/education" className="flex items-center gap-3 rounded-xl px-4 py-2.5 hover:bg-indigo-900/40 transition group"><span className="w-6 h-6 rounded-md bg-indigo-600 flex items-center justify-center text-[10px] font-bold flex-shrink-0">ED</span><span className="text-slate-300 group-hover:text-white transition">Education</span></Link>
              ...
              <div className="px-6 py-4 border-t border-slate-800 text-xs text-slate-500">PipeDesk v1 · 18 Industries · pipedesk.app</div>
            </aside>
