...
const DEMO_DEALS = [
  { id: 1, title: "Johnson Annual Physical", client: "Mary Johnson", value: "Procedure: Physical", commission: "Value: $450", stage: "Referral", hot: true, followUp: "Overdue" },
  { id: 2, title: "Garcia Ortho Consultation", client: "Carlos Garcia", value: "Procedure: Knee Eval", commission: "Value: $800", stage: "Consultation", hot: true, followUp: "Today" },
  { id: 3, title: "Lee Dental Implant", client: "Susan Lee", value: "Procedure: Implant", commission: "Value: $4,200", stage: "Treatment Plan", hot: false, followUp: "Tomorrow" },
  { id: 4, title: "Williams Sleep Study", client: "Bob Williams", value: "Procedure: Sleep Eval", commission: "Value: $1,800", stage: "In Treatment", hot: true, followUp: "Next week" },
  { id: 5, title: "Chen Cardiac Workup", client: "Helen Chen", value: "Procedure: Echo + Stress", commission: "Value: $2,400", stage: "Completed", hot: false, followUp: "Done" },
];

const STAGES = ["Referral", "Consultation", "Treatment Plan", "In Treatment", "Completed"];
    ...
    <div className="min-h-screen bg-white">
      <nav className="border-b border-slate-200 px-6 py-4 flex items-center justify-between sticky top-0 bg-white z-50">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href="/login?mode=signup&industry=healthcare" className="bg-blue-600 hover:bg-blue-700 text-white text-sm font-semibold px-4 py-2 rounded-lg transition">Start free trial</Link>
        </div>
      </nav>
      <section className="bg-slate-900 text-white py-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 bg-blue-600/20 text-blue-400 text-xs font-semibold px-4 py-2 rounded-full mb-6 border border-blue-600/30">🏥 Healthcare Practices & Clinics</div>
          <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Your patient pipeline,\nbuilt for healthcare pros</h1>
          <p className="text-xl text-slate-400 max-w-2xl mx-auto mb-10">Track referrals, consultations, and treatment plans. Log every appointment and follow-up. Built for healthcare practices — not generic CRMs.</p>
          <Link href="/login?mode=signup&industry=healthcare" className="inline-block bg-blue-600 hover:bg-blue-700 text-white font-bold text-lg px-10 py-4 rounded-xl transition">Start your free 14-day trial →</Link>
      ...
      <section className="bg-slate-900 py-20 px-6">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <Link href="/login?mode=signup&industry=healthcare" className="inline-block bg-blue-600 hover:bg-blue-700 text-white font-bold text-lg px-10 py-4 rounded-xl transition">Start free trial →</Link>
