...
const DEMO_DEALS = [
  { id: 1, title: "Martinez Divorce Proceedings", client: "Elena Martinez", value: "Retainer: $5,000", commission: "Case Value: $5,000", stage: "Inquiry", hot: true, followUp: "Overdue" },
  { id: 2, title: "Johnson Business Formation", client: "David Johnson", value: "Retainer: $2,500", commission: "Case Value: $2,500", stage: "Consultation", hot: true, followUp: "Today" },
  { id: 3, title: "Chen Personal Injury", client: "Amy Chen", value: "Contingency: 33%", commission: "Est. Value: $45,000", stage: "Retainer Signed", hot: false, followUp: "Tomorrow" },
  { id: 4, title: "Williams Estate Planning", client: "Robert Williams", value: "Flat Fee: $3,200", commission: "Case Value: $3,200", stage: "Active Case", hot: true, followUp: "Next week" },
  { id: 5, title: "Thompson DUI Defense", client: "Kyle Thompson", value: "Retainer: $7,500", commission: "Case Value: $7,500", stage: "Closed", hot: false, followUp: "Done" },
];

const STAGES = ["Inquiry", "Consultation", "Retainer Signed", "Active Case", "Closed"];
const STAGE_COLORS: Record<string, string> = {
  "Inquiry": "bg-slate-100 text-slate-700",
  "Consultation": "bg-blue-100 text-blue-700",
  "Retainer Signed": "bg-yellow-100 text-yellow-700",
  "Active Case": "bg-purple-100 text-purple-700",
    ...
    <div className="min-h-screen bg-white">
      <nav className="border-b border-slate-200 px-6 py-4 flex items-center justify-between sticky top-0 bg-white z-50">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href="/login?mode=signup&industry=legal" className="bg-blue-600 hover:bg-blue-700 text-white text-sm font-semibold px-4 py-2 rounded-lg transition">Start free trial</Link>
        </div>
      </nav>
      <section className="bg-slate-900 text-white py-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 bg-blue-600/20 text-blue-400 text-xs font-semibold px-4 py-2 rounded-full mb-6 border border-blue-600/30">⚖️ Law Firms & Attorneys</div>
      ...
      <section className="py-16 px-6 bg-slate-50">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
            {[
              { label: "Active Cases", value: String(DEMO_DEALS.length), icon: "⚖️", color: "text-slate-900" },
